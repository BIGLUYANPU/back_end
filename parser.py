...
def ziyouxingl_parser(id):
    try:
        ...
        author_introduction = '' if len(html.xpath('//div[@class="info"]/p'))==0 else html.xpath('//div[@class="info"]/p/text()')[0].strip()
        ...
        ziyouxingl['author_introduction'] = author_introduction
